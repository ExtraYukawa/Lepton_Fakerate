...
for f in ['QCDEM15to20.root']:
  QCD_15to20_list.push_back(path+f)

QCD_20to30_list = ROOT.std.vector('string')()
for f in ['QCDEM20to30.root']:
  QCD_20to30_list.push_back(path+f)

QCD_30to50_list = ROOT.std.vector('string')()
for f in ['QCDEM30to50.root']:
  QCD_30to50_list.push_back(path+f)

QCD_50to80_list = ROOT.std.vector('string')()
for f in ['QCDEM50to80.root']:
  QCD_50to80_list.push_back(path+f)

QCD_80to120_list = ROOT.std.vector('string')()
for f in ['QCDEM80to120.root']:
  QCD_80to120_list.push_back(path+f)

QCD_120to170_list = ROOT.std.vector('string')()
for f in ['QCDEM120to170.root']:
  QCD_120to170_list.push_back(path+f)

QCD_170to300_list = ROOT.std.vector('string')()
for f in ['QCDEM170to300.root']:
  QCD_170to300_list.push_back(path+f)

QCD_300toInf_list = ROOT.std.vector('string')()
for f in ['QCDEM300toInf.root']:
  QCD_300toInf_list.push_back(path+f)

QCD_bctoe_15to20_list = ROOT.std.vector('string')()
for f in ['QCD_bctoE_15to20.root']:
  QCD_bctoe_15to20_list.push_back(path+f)

QCD_bctoe_20to30_list = ROOT.std.vector('string')()
for f in ['QCD_bctoE_20to30.root']:
  QCD_bctoe_20to30_list.push_back(path+f)

QCD_bctoe_30to80_list = ROOT.std.vector('string')()
for f in ['QCD_bctoE_30to80.root']:
  QCD_bctoe_30to80_list.push_back(path+f)

QCD_bctoe_80to170_list = ROOT.std.vector('string')()
for f in ['QCD_bctoE_80to170.root']:
  QCD_bctoe_80to170_list.push_back(path+f)

QCD_bctoe_170to250_list = ROOT.std.vector('string')()
for f in ['QCD_bctoE_170to250.root']:
  QCD_bctoe_170to250_list.push_back(path+f)

QCD_bctoe_250toInf_list = ROOT.std.vector('string')()
for f in ['QCD_bctoE_250toInf.root']:
  QCD_bctoe_250toInf_list.push_back(path+f)
...
#  TTTo1L_ev = get_mcEventnumber(TTTo1L_list)
  ...
  QCD_15to20_xs = 1327000.
  QCD_15to20_ev = get_mcEventnumber(QCD_15to20_list)

  QCD_20to30_xs = 4908000.
  QCD_20to30_ev = get_mcEventnumber(QCD_20to30_list)

  QCD_30to50_xs = 6396000.
  QCD_30to50_ev = get_mcEventnumber(QCD_30to50_list)

  QCD_50to80_xs = 1989000.
  QCD_50to80_ev = get_mcEventnumber(QCD_50to80_list)

  QCD_80to120_xs = 366500.
  QCD_80to120_ev = get_mcEventnumber(QCD_80to120_list)

  QCD_120to170_xs = 66490.
  QCD_120to170_ev = get_mcEventnumber(QCD_120to170_list)

  QCD_170to300_xs = 16480.
  QCD_170to300_ev = get_mcEventnumber(QCD_170to300_list)

  QCD_300toInf_xs = 1099.
  QCD_300toInf_ev = get_mcEventnumber(QCD_300toInf_list)

  QCD_bctoe_15to20_xs = 186200.0
  QCD_bctoe_15to20_ev = get_mcEventnumber(QCD_bctoe_15to20_list)

  QCD_bctoe_20to30_xs = 303800.
  QCD_bctoe_20to30_ev = get_mcEventnumber(QCD_bctoe_20to30_list)

  QCD_bctoe_30to80_xs = 362300.
  QCD_bctoe_30to80_ev = get_mcEventnumber(QCD_bctoe_30to80_list)

  QCD_bctoe_80to170_xs = 33700.
  QCD_bctoe_80to170_ev = get_mcEventnumber(QCD_bctoe_80to170_list)

  QCD_bctoe_170to250_xs = 2125.
  QCD_bctoe_170to250_ev = get_mcEventnumber(QCD_bctoe_170to250_list)

  QCD_bctoe_250toInf_xs = 562.5
  QCD_bctoe_250toInf_ev = get_mcEventnumber(QCD_bctoe_250toInf_list)

  # define the filters here, 1:2mu, 2:1e1m, 3:2ele
  filters_numerator="n_tight_ele==1 &&mt<30 && met<30 && Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && jet_selection_30"
  filters_denominator="(n_tight_ele==1 ||n_fakeable_ele==1)&&mt<30 && met<30&& Flag_goodVertices && Flag_globalSuperTightHalo2016Filter && Flag_HBHENoiseFilter && Flag_HBHENoiseIsoFilter && Flag_EcalDeadCellTriggerPrimitiveFilter && Flag_BadPFMuonFilter && Flag_eeBadScFilter && Flag_ecalBadCalibFilter && jet_selection_30"
...
#    df_TTTo1L_histos.append(df_TTTo1L_histo)
  ...
  df_QCD_300toInf_list_deno_tree = ROOT.RDataFrame("Events",QCD_300toInf_list)
  df_QCD_300toInf_list_deno_tree = df_QCD_300toInf_list_deno_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_300toInf_list_deno_tree = df_QCD_300toInf_list_deno_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_300toInf_list_deno_tree = df_QCD_300toInf_list_deno_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_300toInf_list_deno = df_QCD_300toInf_list_deno_tree.Filter(filters_denominator)
  df_QCD_300toInf_list_deno_trigger = trigger(df_QCD_300toInf_list_deno)
  df_QCD_300toInf_list_deno_histo = df_QCD_300toInf_list_deno_trigger.Histo2D(h2_deno_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_300toInf_list_nume_tree = ROOT.RDataFrame("Events",QCD_300toInf_list)
  df_QCD_300toInf_list_nume_tree = df_QCD_300toInf_list_nume_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_300toInf_list_nume_tree = df_QCD_300toInf_list_nume_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_300toInf_list_nume_tree = df_QCD_300toInf_list_nume_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_300toInf_list_nume = df_QCD_300toInf_list_nume_tree.Filter(filters_numerator)
  df_QCD_300toInf_list_nume_trigger = trigger(df_QCD_300toInf_list_nume)
  df_QCD_300toInf_list_nume_histo = df_QCD_300toInf_list_nume_trigger.Histo2D(h2_nume_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_15to20_list_deno_tree = ROOT.RDataFrame("Events",QCD_bctoe_15to20_list)
  df_QCD_bctoe_15to20_list_deno_tree = df_QCD_bctoe_15to20_list_deno_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_15to20_list_deno_tree = df_QCD_bctoe_15to20_list_deno_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_15to20_list_deno_tree = df_QCD_bctoe_15to20_list_deno_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_15to20_list_deno = df_QCD_bctoe_15to20_list_deno_tree.Filter(filters_denominator)
  df_QCD_bctoe_15to20_list_deno_trigger = trigger(df_QCD_bctoe_15to20_list_deno)
  df_QCD_bctoe_15to20_list_deno_histo = df_QCD_bctoe_15to20_list_deno_trigger.Histo2D(h2_deno_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_15to20_list_nume_tree = ROOT.RDataFrame("Events",QCD_bctoe_15to20_list)
  df_QCD_bctoe_15to20_list_nume_tree = df_QCD_bctoe_15to20_list_nume_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_15to20_list_nume_tree = df_QCD_bctoe_15to20_list_nume_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_15to20_list_nume_tree = df_QCD_bctoe_15to20_list_nume_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_15to20_list_nume = df_QCD_bctoe_15to20_list_nume_tree.Filter(filters_numerator)
  df_QCD_bctoe_15to20_list_nume_trigger = trigger(df_QCD_bctoe_15to20_list_nume)
  df_QCD_bctoe_15to20_list_nume_histo = df_QCD_bctoe_15to20_list_nume_trigger.Histo2D(h2_nume_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_20to30_list_deno_tree = ROOT.RDataFrame("Events",QCD_bctoe_20to30_list)
  df_QCD_bctoe_20to30_list_deno_tree = df_QCD_bctoe_20to30_list_deno_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_20to30_list_deno_tree = df_QCD_bctoe_20to30_list_deno_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_20to30_list_deno_tree = df_QCD_bctoe_20to30_list_deno_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_20to30_list_deno = df_QCD_bctoe_20to30_list_deno_tree.Filter(filters_denominator)
  df_QCD_bctoe_20to30_list_deno_trigger = trigger(df_QCD_bctoe_20to30_list_deno)
  df_QCD_bctoe_20to30_list_deno_histo = df_QCD_bctoe_20to30_list_deno_trigger.Histo2D(h2_deno_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_20to30_list_nume_tree = ROOT.RDataFrame("Events",QCD_bctoe_20to30_list)
  df_QCD_bctoe_20to30_list_nume_tree = df_QCD_bctoe_20to30_list_nume_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_20to30_list_nume_tree = df_QCD_bctoe_20to30_list_nume_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_20to30_list_nume_tree = df_QCD_bctoe_20to30_list_nume_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_20to30_list_nume = df_QCD_bctoe_20to30_list_nume_tree.Filter(filters_numerator)
  df_QCD_bctoe_20to30_list_nume_trigger = trigger(df_QCD_bctoe_20to30_list_nume)
  df_QCD_bctoe_20to30_list_nume_histo = df_QCD_bctoe_20to30_list_nume_trigger.Histo2D(h2_nume_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_30to80_list_deno_tree = ROOT.RDataFrame("Events",QCD_bctoe_30to80_list)
  df_QCD_bctoe_30to80_list_deno_tree = df_QCD_bctoe_30to80_list_deno_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_30to80_list_deno_tree = df_QCD_bctoe_30to80_list_deno_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_30to80_list_deno_tree = df_QCD_bctoe_30to80_list_deno_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_30to80_list_deno = df_QCD_bctoe_30to80_list_deno_tree.Filter(filters_denominator)
  df_QCD_bctoe_30to80_list_deno_trigger = trigger(df_QCD_bctoe_30to80_list_deno)
  df_QCD_bctoe_30to80_list_deno_histo = df_QCD_bctoe_30to80_list_deno_trigger.Histo2D(h2_deno_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_30to80_list_nume_tree = ROOT.RDataFrame("Events",QCD_bctoe_30to80_list)
  df_QCD_bctoe_30to80_list_nume_tree = df_QCD_bctoe_30to80_list_nume_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_30to80_list_nume_tree = df_QCD_bctoe_30to80_list_nume_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_30to80_list_nume_tree = df_QCD_bctoe_30to80_list_nume_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_30to80_list_nume = df_QCD_bctoe_30to80_list_nume_tree.Filter(filters_numerator)
  df_QCD_bctoe_30to80_list_nume_trigger = trigger(df_QCD_bctoe_30to80_list_nume)
  df_QCD_bctoe_30to80_list_nume_histo = df_QCD_bctoe_30to80_list_nume_trigger.Histo2D(h2_nume_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_80to170_list_deno_tree = ROOT.RDataFrame("Events",QCD_bctoe_80to170_list)
  df_QCD_bctoe_80to170_list_deno_tree = df_QCD_bctoe_80to170_list_deno_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_80to170_list_deno_tree = df_QCD_bctoe_80to170_list_deno_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_80to170_list_deno_tree = df_QCD_bctoe_80to170_list_deno_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_80to170_list_deno = df_QCD_bctoe_80to170_list_deno_tree.Filter(filters_denominator)
  df_QCD_bctoe_80to170_list_deno_trigger = trigger(df_QCD_bctoe_80to170_list_deno)
  df_QCD_bctoe_80to170_list_deno_histo = df_QCD_bctoe_80to170_list_deno_trigger.Histo2D(h2_deno_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_80to170_list_nume_tree = ROOT.RDataFrame("Events",QCD_bctoe_80to170_list)
  df_QCD_bctoe_80to170_list_nume_tree = df_QCD_bctoe_80to170_list_nume_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_80to170_list_nume_tree = df_QCD_bctoe_80to170_list_nume_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_80to170_list_nume_tree = df_QCD_bctoe_80to170_list_nume_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_80to170_list_nume = df_QCD_bctoe_80to170_list_nume_tree.Filter(filters_numerator)
  df_QCD_bctoe_80to170_list_nume_trigger = trigger(df_QCD_bctoe_80to170_list_nume)
  df_QCD_bctoe_80to170_list_nume_histo = df_QCD_bctoe_80to170_list_nume_trigger.Histo2D(h2_nume_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_170to250_list_deno_tree = ROOT.RDataFrame("Events",QCD_bctoe_170to250_list)
  df_QCD_bctoe_170to250_list_deno_tree = df_QCD_bctoe_170to250_list_deno_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_170to250_list_deno_tree = df_QCD_bctoe_170to250_list_deno_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_170to250_list_deno_tree = df_QCD_bctoe_170to250_list_deno_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_170to250_list_deno = df_QCD_bctoe_170to250_list_deno_tree.Filter(filters_denominator)
  df_QCD_bctoe_170to250_list_deno_trigger = trigger(df_QCD_bctoe_170to250_list_deno)
  df_QCD_bctoe_170to250_list_deno_histo = df_QCD_bctoe_170to250_list_deno_trigger.Histo2D(h2_deno_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_170to250_list_nume_tree = ROOT.RDataFrame("Events",QCD_bctoe_170to250_list)
  df_QCD_bctoe_170to250_list_nume_tree = df_QCD_bctoe_170to250_list_nume_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_170to250_list_nume_tree = df_QCD_bctoe_170to250_list_nume_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_170to250_list_nume_tree = df_QCD_bctoe_170to250_list_nume_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_170to250_list_nume = df_QCD_bctoe_170to250_list_nume_tree.Filter(filters_numerator)
  df_QCD_bctoe_170to250_list_nume_trigger = trigger(df_QCD_bctoe_170to250_list_nume)
  df_QCD_bctoe_170to250_list_nume_histo = df_QCD_bctoe_170to250_list_nume_trigger.Histo2D(h2_nume_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_250toInf_list_deno_tree = ROOT.RDataFrame("Events",QCD_bctoe_250toInf_list)
  df_QCD_bctoe_250toInf_list_deno_tree = df_QCD_bctoe_250toInf_list_deno_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_250toInf_list_deno_tree = df_QCD_bctoe_250toInf_list_deno_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_250toInf_list_deno_tree = df_QCD_bctoe_250toInf_list_deno_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_250toInf_list_deno = df_QCD_bctoe_250toInf_list_deno_tree.Filter(filters_denominator)
  df_QCD_bctoe_250toInf_list_deno_trigger = trigger(df_QCD_bctoe_250toInf_list_deno)
  df_QCD_bctoe_250toInf_list_deno_histo = df_QCD_bctoe_250toInf_list_deno_trigger.Histo2D(h2_deno_model,"abs_l1eta","l1_pt",'genweight')

  df_QCD_bctoe_250toInf_list_nume_tree = ROOT.RDataFrame("Events",QCD_bctoe_250toInf_list)
  df_QCD_bctoe_250toInf_list_nume_tree = df_QCD_bctoe_250toInf_list_nume_tree.Define("abs_l1eta","abs(l1_eta)")
  df_QCD_bctoe_250toInf_list_nume_tree = df_QCD_bctoe_250toInf_list_nume_tree.Define("eff_lumi","MC_eff_lumi(l1_pt)")
  df_QCD_bctoe_250toInf_list_nume_tree = df_QCD_bctoe_250toInf_list_nume_tree.Define("genweight","puWeight*eff_lumi*PrefireWeight*genWeight/abs(genWeight)")
  df_QCD_bctoe_250toInf_list_nume = df_QCD_bctoe_250toInf_list_nume_tree.Filter(filters_numerator)
  df_QCD_bctoe_250toInf_list_nume_trigger = trigger(df_QCD_bctoe_250toInf_list_nume)
  df_QCD_bctoe_250toInf_list_nume_histo = df_QCD_bctoe_250toInf_list_nume_trigger.Histo2D(h2_nume_model,"abs_l1eta","l1_pt",'genweight')
...
#  df_TTTo1L_nume_histo.Draw()
  ...
  df_QCD_300toInf_list_deno_histo.Draw()
  df_QCD_300toInf_list_nume_histo.Draw()
  df_QCD_bctoe_15to20_list_deno_histo.Draw()
  df_QCD_bctoe_15to20_list_nume_histo.Draw()
  df_QCD_bctoe_20to30_list_deno_histo.Draw()
  df_QCD_bctoe_20to30_list_nume_histo.Draw()
  df_QCD_bctoe_30to80_list_deno_histo.Draw()
  df_QCD_bctoe_30to80_list_nume_histo.Draw()
  df_QCD_bctoe_80to170_list_deno_histo.Draw()
  df_QCD_bctoe_80to170_list_nume_histo.Draw()
  df_QCD_bctoe_170to250_list_deno_histo.Draw()
  df_QCD_bctoe_170to250_list_nume_histo.Draw()
  df_QCD_bctoe_250toInf_list_deno_histo.Draw()
  df_QCD_bctoe_250toInf_list_nume_histo.Draw()
...
#  h_TTTo1L_nume=df_TTTo1L_nume_histo.GetValue()
  ...
  h_300toInf_deno=df_QCD_300toInf_list_deno_histo.GetValue()
  h_300toInf_nume=df_QCD_300toInf_list_nume_histo.GetValue()
  h_bctoe_15to20_deno=df_QCD_bctoe_15to20_list_deno_histo.GetValue()
  h_bctoe_15to20_nume=df_QCD_bctoe_15to20_list_nume_histo.GetValue()
  h_bctoe_20to30_deno=df_QCD_bctoe_20to30_list_deno_histo.GetValue()
  h_bctoe_20to30_nume=df_QCD_bctoe_20to30_list_nume_histo.GetValue()
  h_bctoe_30to80_deno=df_QCD_bctoe_30to80_list_deno_histo.GetValue()
  h_bctoe_30to80_nume=df_QCD_bctoe_30to80_list_nume_histo.GetValue()
  h_bctoe_80to170_deno=df_QCD_bctoe_80to170_list_deno_histo.GetValue()
  h_bctoe_80to170_nume=df_QCD_bctoe_80to170_list_nume_histo.GetValue()
  h_bctoe_170to250_deno=df_QCD_bctoe_170to250_list_deno_histo.GetValue()
  h_bctoe_170to250_nume=df_QCD_bctoe_170to250_list_nume_histo.GetValue()
  h_bctoe_250toInf_deno=df_QCD_bctoe_250toInf_list_deno_histo.GetValue()
  h_bctoe_250toInf_nume=df_QCD_bctoe_250toInf_list_nume_histo.GetValue()
  ...
  h_300toInf_deno.Scale(QCD_300toInf_xs/QCD_300toInf_ev)
  h_300toInf_nume.Scale(QCD_300toInf_xs/QCD_300toInf_ev)
  h_bctoe_15to20_deno.Scale(QCD_bctoe_15to20_xs/QCD_bctoe_15to20_ev)
  h_bctoe_15to20_nume.Scale(QCD_bctoe_15to20_xs/QCD_bctoe_15to20_ev)
  h_bctoe_20to30_deno.Scale(QCD_bctoe_20to30_xs/QCD_bctoe_20to30_ev)
  h_bctoe_20to30_nume.Scale(QCD_bctoe_20to30_xs/QCD_bctoe_20to30_ev)
  h_bctoe_30to80_deno.Scale(QCD_bctoe_30to80_xs/QCD_bctoe_30to80_ev)
  h_bctoe_30to80_nume.Scale(QCD_bctoe_30to80_xs/QCD_bctoe_30to80_ev)
  h_bctoe_80to170_deno.Scale(QCD_bctoe_80to170_xs/QCD_bctoe_80to170_ev)
  h_bctoe_80to170_nume.Scale(QCD_bctoe_80to170_xs/QCD_bctoe_80to170_ev)
  h_bctoe_170to250_deno.Scale(QCD_bctoe_170to250_xs/QCD_bctoe_170to250_ev)
  h_bctoe_170to250_nume.Scale(QCD_bctoe_170to250_xs/QCD_bctoe_170to250_ev)
  h_bctoe_250toInf_deno.Scale(QCD_bctoe_250toInf_xs/QCD_bctoe_250toInf_ev)
  h_bctoe_250toInf_nume.Scale(QCD_bctoe_250toInf_xs/QCD_bctoe_250toInf_ev)
...
#  histos_deno.append(h_TTTo1L_deno.Clone())
  ...
  histos_deno.append(h_300toInf_deno.Clone())
  histos_deno.append(h_bctoe_15to20_deno.Clone())
  histos_deno.append(h_bctoe_20to30_deno.Clone())
  histos_deno.append(h_bctoe_30to80_deno.Clone())
  histos_deno.append(h_bctoe_80to170_deno.Clone())
  histos_deno.append(h_bctoe_170to250_deno.Clone())
  histos_deno.append(h_bctoe_250toInf_deno.Clone())
...
#  histos_nume.append(h_TTTo1L_nume.Clone())
  ...
  histos_nume.append(h_300toInf_nume.Clone())
  histos_nume.append(h_bctoe_15to20_nume.Clone())
  histos_nume.append(h_bctoe_20to30_nume.Clone())
  histos_nume.append(h_bctoe_30to80_nume.Clone())
  histos_nume.append(h_bctoe_80to170_nume.Clone())
  histos_nume.append(h_bctoe_170to250_nume.Clone())
  histos_nume.append(h_bctoe_250toInf_nume.Clone())
